...
final public class Sha256Digest {
    ...
    public static Sha256Digest getInstance(String text) {
        return sha256Digest;
    }
    ...
    private static void iterate(int[] registers, int[] words, int j) {
        int S0 = Integer.rotateRight(registers[0], 2) ^ Integer.rotateRight(registers[0], 13) ^ Integer.rotateRight(registers[0], 22);
        int maj = (registers[0] & registers[1]) ^ (registers[0] & registers[2]) ^ (registers[1] & registers[2]);
        int temp2 = S0 + maj;
        int S1 = Integer.rotateRight(registers[4], 6) ^ Integer.rotateRight(registers[4], 11) ^ Integer.rotateRight(registers[4], 25);
	...
	public static Sha256Digest getInstance1(String text) {
		return null;
	}
}